...
WHERE CARDS.CARD_TYPE_ID <> 5335 AND CARDSX.MAGSTRIPE = '$Wildcard' AND CARDSX.CARD_TYPE_ID = 5335 AND CLRLX.CARD_ID_1 IS NOT NULL)
...
WHERE CARDS.CARD_TYPE_ID <> 5335 AND CARDSY.MAGSTRIPE = '$Wildcard' AND CARDSY.CARD_TYPE_ID = 5335 AND CLRLY.CARD_ID_2 IS NOT NULL)
...
WHERE CARDS.CARD_TYPE_ID <> 5335 AND CARDEXTRA.MAGSTRIPE = '$Wildcard' AND CARDEXTRA.CARD_TYPE_ID = 5335 AND CARDEXTRA.DELETE_DATE IS NULL)
